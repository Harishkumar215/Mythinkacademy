...
const TeacherForgot = () => {
    ...
    const  { email, err, success } = teacher
    ...
    const forgotPassword = async () => {
        if(isEmpty(email))
                return setTeacher({...teacher, err: 'Please fill in all fields.' , success: ''})
        
        if(!isEmail(email))
                return setTeacher({...teacher, err: 'Invalid Email.' , success: ''})
        try {
                            ...
                            <div className="w-full md:w-3/5">
                                ...
                                <div className="mt-2 pt-8 p-2 md:p-8">
                                    ...
                                    <div className="pt-2.5 pl-4">
                                        <Link to="/teacher/login"><span className="text-blue-600">Remember Password ?</span></Link>
                                    </div>
                                </div>
                            </div>
