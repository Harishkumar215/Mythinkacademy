...
const ParentForgot = () => {
    ...
    const  { email, err, success } = parent
    ...
    const forgotPassword = async () => {
        ...
        try {
            const res = await axios.post('/parent/forgot', {email})
                            ...
                            <div className="w-full md:w-3/5">
                                ...
                                <div className="mt-2 pt-8 p-2 md:p-8">
                                    ...
                                    <div className="pt-2.5 pl-4">
                                        <Link to="/parent/login"><span className="text-blue-600">Remember Password ?</span></Link>
                                    </div>
                                </div>
                            </div>
