        ...
        <div className={sidebarOpen ? 'translate-x-0 ease-out border-r-2 fixed z-30 inset-y-0 left-0 w-60 transition bg-white duration-300 transform overflow-y-auto lg:translate-x-0 lg:static lg:inset-0' : '-translate-x-full ease-in border-r-2 fixed z-30 inset-y-0 left-0 w-60 transition bg-white duration-300 transform overflow-y-auto lg:translate-x-0 lg:static lg:inset-0'}>
            ...
            <nav className="mt-24 pl-4 navbar-nav">
                <div className="nav-list text-black rounded-l-lg hover:text-blue-600 hover:bg-gray-200">
                    <NavLink className="mt-5 py-3 px-6 rounded-l-lg flex items-center font-medium text-gray-700" to="/admin/overview">
                ...
                <div className="nav-list text-black rounded-l-lg hover:text-blue-600 hover:bg-gray-200">
                    <NavLink className="mt-5 py-3 px-6 rounded-l-lg flex items-center font-medium text-gray-700 " to="/admin/teacher">
                ...
                <div className="nav-list text-black rounded-l-lg hover:text-blue-600 hover:bg-gray-200">
                    <NavLink className="mt-5 py-3 px-6 rounded-l-lg flex items-center font-medium text-gray-700 " to="/admin/teams">
                        <FaRegHandshake size={25} />
                        <span className="mx-3">Teams</span>
                    </NavLink>
                </div>
                <div className="nav-list text-black rounded-l-lg hover:text-blue-600 hover:bg-gray-200">
                    <NavLink className="mt-5 py-3 px-6 rounded-l-lg flex items-center font-medium text-gray-700 " to="/admin/analytics">
                        <IoAnalytics size={25} />
