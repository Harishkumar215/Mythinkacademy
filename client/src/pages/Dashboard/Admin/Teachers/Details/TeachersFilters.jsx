...
function TeachersFilters() {
    ...
    return (
        <div className="grid grid-cols-1 grid-cols-5 gap-4 w-full">
        <div className="mb-4">
                ...
                <div className="mb-4">
                    <label className="block text-black font-medium text-sm mb-2">Search by Email</label>
                ...
                <div className="mb-4">
                    <label className="block text-black font-medium text-sm mb-2">Search by Team</label>
                    <input type="text" defaultValue={search_name} placeholder="Enter category name" className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" />
                </div>
                <div className="mb-4">
                    <label className="block text-black font-medium text-sm mb-2">Search by subject</label>
                    <input type="text" defaultValue={search_name} placeholder="Enter category name" className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" />
                </div>
        </div>
    )
