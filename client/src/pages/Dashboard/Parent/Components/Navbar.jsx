...
const DashboardParentNavbar = ({ sidebarOpen, openSidebar}) => {
        ...
        <header className="container mx-auto max-w-8xl flex justify-between items-center py-4 px-6 bg-white">
            <div className="flex items-center">
                ...
                <div className="relative mx-4 lg:mx-0">
                    <h1 className="lg:text-xl">Welcome <span className="capitalize">{parent.firstName}</span></h1>
                </div>
            </div>
            <div className="flex items-center">
                ...
                <div className="dropdown inline-block relative ">
                    ...
                    <ul className="dropdown-menu hidden absolute right-0 pt-2 w-80 bg-white rounded-lg shadow-xl overflow-hidden z-10">
                        <li className="">
                            <Link to="#" className="flex items-center px-4 py-3 text-gray-600 hover:text-white hover:bg-indigo-600 -mx-2">
                ...
                <div className="relative">
                    <div className="dropdown inline-block relative">
                        ...
                        <ul className="dropdown-menu hidden absolute right-0 pt-1 w-48 bg-white rounded-md overflow-hidden shadow-xl z-10">
                            <li className=""><Link className="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white" to="/parent/profile">Profile</Link></li>
                            <li className=""><Link onClick={handleLogout} className="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white" to="/">Logout</Link></li>
                        </ul>
                    </div>
                </div>
            </div>
...
export default DashboardParentNavbar
